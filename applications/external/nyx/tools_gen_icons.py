#!/usr/bin/env python3
"""Generate 1-bit 10x10 Flipper icons for Nyx from ASCII bitmaps.
...
GLYPHS = {
    # App mark: a crescent moon (Nyx, the night) with an IR spark
    "nyx_10px": [
        "...####...",
        "..##......",
        ".##.......",
    ...
    # Emitter: a source with radiating beams
    "beam_10px": [
        "....#.....",
        "#...#...#.",
        ".#..#..#..",
