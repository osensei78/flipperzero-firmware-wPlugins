#!/usr/bin/env python3
"""Generate 1-bit 10x10 Flipper icons for Argus from ASCII bitmaps.
...
GLYPHS = {
    # App mark + about icon: the all-seeing eye
    "argus_10px": [
        "..........",
        "...####...",
        ".##....##.",
