 ...
 * 
 * @param instance Pointer to a FuzzerWorker
 * @param idle_time Delay between emulations in hundredths of a second (10ms units)
 * @param emu_time Emulation time of one UID in hundredths of a second (10ms units)
