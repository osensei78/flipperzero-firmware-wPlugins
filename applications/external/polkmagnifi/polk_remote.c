...
static const InfraredMessage IR_INPUT_HDMI =
    {InfraredProtocolNECext, POLK_ADDR, 0x0000F00Fu, false};
static const InfraredMessage IR_VOICE_UP = {InfraredProtocolNECext, POLK_ADDR, 0x0000956Au, false};
static const InfraredMessage IR_VOICE_DOWN =
    {InfraredProtocolNECext, POLK_ADDR, 0x0000946Bu, false};
...
static const InfraredMessage IR_MODE_CINEMA =
    {InfraredProtocolNECext, POLK_ADDR, 0x00008877u, false};
static const InfraredMessage IR_MODE_SPORTS =
    {InfraredProtocolNECext, POLK_ADDR, 0x00008679u, false};
static const InfraredMessage IR_MODE_MUSIC =
    {InfraredProtocolNECext, POLK_ADDR, 0x00008778u, false};
static const InfraredMessage IR_MODE_NIGHT =
    {InfraredProtocolNECext, POLK_ADDR, 0x00008E71u, false};
...
static const InfraredMessage* const input_cmds[] = {&IR_INPUT_AUX, &IR_INPUT_OPT, &IR_INPUT_HDMI};
...
static PolkRemoteApp* polk_remote_alloc(void) {
    ...
    view_dispatcher_set_navigation_event_callback(app->view_dispatcher, polk_navigation_event_cb);
