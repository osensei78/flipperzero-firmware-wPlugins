...
MJDuckyKey mj_ducky_keys[] = {{" ", 44, 0},         {"!", 56, 0},         {"\"", 32, 0},
                              ...
                              {",", 16, 0},         {"-", 35, 0},         {".", 54, 2},
                              {"/", 55, 2},         {"0", 39, 2},         {"1", 30, 2},
                              {"2", 31, 2},         {"3", 32, 2},         {"4", 33, 2},
                              {"5", 34, 2},         {"6", 35, 2},         {"7", 36, 2},
                              {"8", 37, 2},         {"9", 38, 2},         {":", 55, 0},
                              {";", 54, 0},         {"<", 100, 0},        {"=", 46, 0},
                              {">", 100, 2},        {"?", 16, 2},         {"@", 39, 64},
                              {"A", 20, 2},         {"B", 5, 2},          {"C", 6, 2},
                              ...
                              {"M", 51, 2},         {"N", 17, 2},         {"O", 18, 2},
                              {"P", 19, 2},         {"Q", 4, 2},          {"R", 21, 2},
                              {"S", 22, 2},         {"T", 23, 2},         {"U", 24, 2},
                              {"V", 25, 2},         {"W", 29, 2},         {"X", 27, 2},
                              {"Y", 28, 2},         {"Z", 26, 2},         {"[", 34, 64},
                              {"\\", 37, 64},       {"]", 45, 64},        {"^", 38, 64},
                              {"_", 37, 0},         {"`", 36, 64},        {"a", 20, 0},
                              {"b", 5, 0},          {"c", 6, 0},          {"d", 7, 0},
                              ...
                              {"k", 14, 0},         {"l", 15, 0},         {"m", 51, 0},
                              {"n", 17, 0},         {"o", 18, 0},         {"p", 19, 0},
                              {"q", 4, 0},          {"r", 21, 0},         {"s", 22, 0},
                              {"t", 23, 0},         {"u", 24, 0},         {"v", 25, 0},
                              {"w", 29, 0},         {"x", 27, 0},         {"y", 28, 0},
                              {"z", 26, 0},         {"{", 33, 64},        {"|", 35, 64},
                              {"}", 46, 64},        {"~", 31, 64},        {"BACKSPACE", 42, 0},
