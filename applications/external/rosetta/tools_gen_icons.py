#!/usr/bin/env python3
"""Generate the 1-bit 10x10 Flipper app icon for Rosetta from an ASCII bitmap.
...
GLYPHS = {
    # App mark: an inscribed stone tablet - the "Rosetta stone" of protocols,
    # its rows of script standing in for decoded fields.
    "rosetta_10px": [
        ".########.",
        "#........#",
        "#.######.#",
