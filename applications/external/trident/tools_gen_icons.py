#!/usr/bin/env python3
"""Generate 1-bit 10x10 Flipper icons for Trident from ASCII bitmaps.
...
GLYPHS = {
    # App mark + about icon: a trident (three prongs = ESP32 / NRF24 / CC1101)
    "trident_10px": [
        ".#..#..#..",
        ".#..#..#..",
        ".#..#..#..",
    ...
    # Attack-confirmation icon: skull
    "skull_10px": [
        "..######..",
        ".########.",
        "##..##..##",
