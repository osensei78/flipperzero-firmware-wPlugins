...
Source code for this example can be found [here](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/tree/dev/applications/examples/example_apps_assets).
