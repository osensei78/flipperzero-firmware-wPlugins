...
> [!note]
> You can find the implementation of all supported JS modules in the [Flipper Zero firmware repository](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/tree/dev/applications/system/js_app/modules). Also, check out the [docs for JS modules](#js_modules) for more details.
