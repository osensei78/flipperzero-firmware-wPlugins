...
Here you can find info on how to install Asset Packs and also how to make your own. You can easily create your own pack, or find <a href="https://github.com/RogueMaster/awesome-flipperzero-withModules/tree/rogue_main/RM_AssetPacks">RM Asset Packs HERE</a>, or find some community-made ones on <b><a href="https://momentum-fw.dev/asset-packs">the MNTM website</a> or on Discord</b>.

<br>

## How to install Asset Packs?

Installing Asset Packs is quite easy and straightforward. First, make sure you're on an updated version of RM before you begin, Asset Packs were added in v40! Then, find some packs to install (we have a channel in our discord where you can find some) or make your own (see below). Once you have some packs to install:
...
- Now simply open the Momentum Settings app (from the home screen press `Arrow UP` and then `CFW Settings`) and select the asset pack you want. When you back out, Flipper will restart and your animations and icons will use the ones from the selected pack!
